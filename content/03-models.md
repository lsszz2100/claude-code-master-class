...
**effort를 지원하는 모델**은 Fable 5·Opus 5·Sonnet 5와 레거시 Opus·Sonnet 계열입니다. **Haiku 4.5는 effort도, 적응형 사고도 지원하지 않습니다** — 저비용·저지연이 이미 그 모델의 성격이라 조절할 레버가 없다고 보면 됩니다.
...
**Fast 모드**는 Opus를 같은 지능으로 유지하면서 **출력 속도를 최대 2.5배**까지 올립니다(프리미엄 가격, 리서치 프리뷰). 작은 모델로 낮추는 게 아니라 같은 Opus를 더 빠르게 내보냅니다. Claude Code에서는 **Opus 5·4.8·4.7에서만** 쓸 수 있습니다 — Sonnet이나 Haiku에서는 토글해도 효과가 없습니다.
...
- **`/fast`**는 Opus를 최대 2.5배 빠르게(프리미엄, Opus 티어 전용). 적응형 사고는 스스로 사고량을 정하고, **Haiku 4.5는 effort·적응형 사고 대상이 아니다.**
